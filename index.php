...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/depositphotos_194094412-stock-photo-food-lunch-boxes-delivery-food.jpg">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 483 483" width="512" height="512">
                                <g fill="#FFF">
                                    <path d=</path>
                                <img src="images/icons8-hotel-building-64.png" width="30" height="30" alt=""/>                                </g>
                            </svg>
                      <h4><span style="color:white;">1. </span>Choose Restaurant</h4> </div>
                        ...
                        <div class="step-item step2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewbox="0 0 380.721 380.721">
                                <g fill="#FFF">
                                    <path d= />
                                  <img src="images/icons8-waitress-50 (1).png" width="30" height="30" alt=""/> </g>
                            </svg>
                      <h4><span style="color:white;">2. </span>Order Food</h4> </div>
                        ...
                        <div class="step-item step3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewbox="0 0 612.001 612">
                                <path d= />
                              <img src="images/icons8-take-away-food-50.png" width="30" height="30" alt=""/> </svg>
                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" data-image-src="images/Res_img/dishes/'.$r['img'].'"></div>
                                                <div class="content">
                            ...
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    <div class="icon" data-step="1">
                                            ...
                                            <img src="images/icons8-hotel-building-64.png" width="64" height="64" alt=""/>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                              <div class="icon" data-step="2">
                                        ...
                                        <g fill="#FFF">
                                            <path d= </g>
                                <img src="images/icons8-waitress-50 (1).png" width="50" height="50" alt=""/>
                                  </svg>
                                </div>
                                <h3>Choose a dish</h3>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                              <div class="icon" data-step="3">
                                        ...
                                        <path d= />
                                      <img src="images/icons8-take-away-food-50.png" width="50" height="50" alt=""/>
</svg>
                                </div>
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="images/Res_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
